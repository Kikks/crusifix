...
const TermsAndConditions: NextPage = () => {
	return (
		<div className={styles.container}>
			...
			<p>Last updated: 2021-12-01</p>
			<p>
				1. <b>Introduction</b>
			</p>
			<p>
				Welcome to <b>Crusifix games and lounge</b> (“Company”, “we”, “our”,
				“us”)!
			</p>
			<p>
				These Terms of Service (“Terms”, “Terms of Service”) govern your use of
				our website located at <b>https://crusifix.vercel.app/</b> (together or
				individually “Service”) operated by <b>Crusifix games and lounge</b>.
			</p>
			<p>
			...
			<p>
				...
				<b>crusifixgamesng@gmail.com</b> so we can try to find a solution. These
			...
			<p>
				Crusifix games and lounge has the right but not the obligation to
				monitor and edit all Content provided by users.
			</p>
			<p>
				In addition, Content found on or through this Service are the property
				of Crusifix games and lounge or used with permission. You may not
			...
			<p>
				...
				Crusifix games and lounge and its licensors. Service is protected by
				...
				without the prior written consent of Crusifix games and lounge.
			</p>
			<p>
			...
			<p>
				...
				to crusifixgamesng@gmail.com, with the subject line: “Copyright
			...
			<p>
				You may provide us either directly at crusifixgamesng@gmail.com or via
			...
			<p>
				...
				are not owned or controlled by Crusifix games and lounge.
			</p>
			<p>
				Crusifix games and lounge has no control over, and assumes no
			...
			<p>
				...
				email: <b>crusifixgamesng@gmail.com</b>.
			</p>
		</div>
	);
};
